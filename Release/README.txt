...
The installer automatically extracts to the install drive's short Unpacking
path, then moves the files into <selected install root>\<archive_name>. After
a successful installation, the empty Unpacking folder is removed.
