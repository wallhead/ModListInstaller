...
`Build Package` writes archive parts into `data\downloads`, writes the manifest into `data\package`, and refreshes the native installer exe, CSS theme, and support tools. No browser runtime is bundled.
